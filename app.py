...
st.markdown("""
    <style>
        ...
        /* Insight Box - PERBAIKAN TAMPILAN */
        .insight-box {
            background-color: #1E293B; /* Dark background like reference */
    ...
    if df_test.empty:
        ...
        <div class='insight-box'>
            ...
            <div class='insight-content'>
                ...
                <ul>
                    <li><b>Akurasi:</b> Model {best_model} memiliki deviasi <b>{improvement:.2f}</b> poin lebih kecil dibandingkan kompetitornya, menjadikannya pilihan utama untuk prediksi jangka pendek.</li>
